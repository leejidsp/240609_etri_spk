...
def main(args):
    ...
    split_dict = {  'train': 'train-clean-100',
                    'valid': 'dev-clean',
                    'test': 'test-clean'}
    data_root_split_dir = args.data_root_dir + split_dict[args.data_split]
    #-- data_root_split_dir: ex. /home/leeji/home1/dataset/LibriSpeech/train-clean-100
    ...
    for (root_dir, sub_dir, files) in sorted(os.walk(data_root_split_dir)):
        for fname in sorted(files):
            ...
            fpath = fpath.replace('/home/leeji/home1/dataset/LibriSpeech/', 'LibriSpeech/')
            # fpath: LibriSpeech/train-clean-100/~~~/.flac
            path_list.append(fpath)

    # Save path list to json file
    output_name = args.data_name + '_' + args.data_split + '.json'      # ex. LibriSpeech_train.json
...
if __name__ == '__main__':
    ...
    print("data_split:      ", args.data_split)
